...
public final class ToastUtils {
    ...
    /**
     * Set the msg size of message.
     *
     * @param textSize The msg size of message.
     */
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = Toast.makeText(SmallUtils.getApp(), text, duration);
     ...
     * Show the sToast for a short period of time.
     *
     * @param resId The resource id for msg.
     */
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(SmallUtils.getApp().getResources().getText(resId).toString(), duration);
    }
    ...
    private static View getView(@LayoutRes final int layoutId) {
        LayoutInflater inflate = (LayoutInflater) SmallUtils.getApp().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = new Toast(SmallUtils.getApp());
                sToast.setView(view);
